...
class AutomatorWP_MailPoet_Add_User_To_List extends AutomatorWP_Integration_Action {
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Add user to a list', 'automatorwp-mailpoet' ),
            'select_option'     => __( 'Add user to a <strong>list</strong>', 'automatorwp-mailpoet' ),
            /* translators: %1$s: List. */
            'edit_label'        => sprintf( __( 'Add user to %1$s', 'automatorwp-mailpoet' ), '{list}' ),
            /* translators: %1$s: List. */
            'log_label'         => sprintf( __( 'Add user to %1$s', 'automatorwp-mailpoet' ), '{list}' ),
            'options'           => array(
                'list' => array(
                    'from' => 'list',
                    'fields' => array(
